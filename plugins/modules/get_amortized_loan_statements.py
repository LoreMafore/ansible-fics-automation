...
def get_amortized_loan_statement(
    ...
    params: dict = {
        "Message":{
            ...
            "IncludeAutomatedClearingHouse": True,
            "IncludePayrollDeduction": True,
            "IncludeCoupons": True,
            "IncludeDisbursementHistory": True,
            "IncludePif": False,
            "IncludeBankruptcyOnlyLoans": False,
            "SendEmail": False,
            "UseLogo": False,
            "OkUseLogo": False,
            "Update": api_update,
...
def run_module():
    ...
    trial_resp: dict = get_amortized_loan_statement(
        api_url=api_url, 
        api_token=api_token, 
    ...
    try:
        if trial_resp.get("ApiCallSuccessful", None):
            ...
            base64_file = trial_resp.get("SummaryReport", {}).get("DocumentBase64", None)
            if base64_file:
